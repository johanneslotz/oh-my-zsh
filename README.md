...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/johanneslotz/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/johanneslotz/oh-my-zsh/master/tools/install.sh -O -)"
```
